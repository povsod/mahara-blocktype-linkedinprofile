...
$string['apikey'] = 'Client ID';
$string['apikeydesc'] = 'When you create an application in LinkedIn, you\'ll get a Client ID. Paste it here.';
$string['secretkey'] = 'Client Secret';
$string['secretkeydesc'] = 'When you create an application, you\'ll also get a Client Secret. Paste it here and don\'t share it with anyone.';
